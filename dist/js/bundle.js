...
module.exports["default"] = module.exports, module.exports.__esModule = true;
},{"./objectWithoutPropertiesLoose.js":"../../node_modules/@babel/runtime/helpers/objectWithoutPropertiesLoose.js"}],"../../node_modules/@babel/runtime/helpers/arrayLikeToArray.js":[function(require,module,exports) {
...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"../../node_modules/@chec/commerce.js/lib/index.js":[function(require,module,exports) {
...
},{"@babel/runtime/helpers/objectWithoutProperties":"../../node_modules/@babel/runtime/helpers/objectWithoutProperties.js","@babel/runtime/helpers/toConsumableArray":"../../node_modules/@babel/runtime/helpers/toConsumableArray.js","@babel/runtime/helpers/typeof":"../../node_modules/@babel/runtime/helpers/typeof.js","@babel/runtime/helpers/defineProperty":"../../node_modules/@babel/runtime/helpers/defineProperty.js","@babel/runtime/helpers/classCallCheck":"../../node_modules/@babel/runtime/helpers/classCallCheck.js","@babel/runtime/helpers/createClass":"../../node_modules/@babel/runtime/helpers/createClass.js","@babel/runtime/regenerator":"../../node_modules/@babel/runtime/regenerator/index.js","@babel/runtime/helpers/asyncToGenerator":"../../node_modules/@babel/runtime/helpers/asyncToGenerator.js","axios":"../../node_modules/axios/index.js"}],"modules/commonjs.js":[function(require,module,exports) {
"use strict";
...
exports.captureOder = captureOder;
...
var public_api_key = "pk_27307555d22166c861d7e37f8188fb8debfd30bf2453f"; // Create a Commerce instance
...
function _removeFromCart() {
  _removeFromCart = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(productId) {
...
function generateCheckoutToken(_x6) {
  return _generateCheckoutToken.apply(this, arguments);
}

function _generateCheckoutToken() {
  _generateCheckoutToken = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(cart_id) {
    return regeneratorRuntime.wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            _context6.next = 2;
            return commerce.checkout.generateTokenFrom("cart", cart_id);
...
function captureOder(_x7, _x8) {
  return _captureOder.apply(this, arguments);
}

function _captureOder() {
  _captureOder = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee7(token, checkoutObj) {
    return regeneratorRuntime.wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            _context7.next = 2;
            return commerce.checkout.capture(token, checkoutObj);
...
},{}],"modules/orderSummaryItemTemplate.js":[function(require,module,exports) {
"use strict";
...
function _default(lineItem) {
  return "<div class=\"order__item\">\n    <span class=\"name\">".concat(lineItem.name, "</span>\n    <span class=\"quantity\"> x").concat(lineItem.quantity, "</span>\n    <span class=\"price\">").concat(lineItem.line_total.formatted_with_symbol, "</span>\n  </div>");
}
},{}],"modules/updateUI.js":[function(require,module,exports) {
"use strict";
...
exports.populateOrderSummaryUI = populateOrderSummaryUI;
...
var _orderSummaryItemTemplate = _interopRequireDefault(require("./orderSummaryItemTemplate"));
...
var oderSummaryItems = document.querySelector(".order__items");
var orderTotal = document.querySelector(".order__total span");

function updateProductsUI(products) {
  var altenator = 0;
  var cardStrings = products.data.map(function (product, index) {
    if (product.is.sold_out) return;
    var isCardLeft = (altenator + 1) % 2 === 0 ? true : false; // alternate type of card
...
function populateOrderSummaryUI(cart) {
  var lineItems = cart.line_items.map(function (item) {
    return (0, _orderSummaryItemTemplate.default)(item);
  });
...
var btnPayment = document.querySelector(".btn-complete-payment");
var useShipping = document.querySelector("#useshipping");
var nextStepPayment = document.querySelector(".step-next--payment");
var nextStepShipping = document.querySelector(".step-next--shipping");
var billingEdit = document.querySelector(".summary__btn-edit--billing");
var shippingEdit = document.querySelector(".summary__btn-edit--shipping");
var billingSummary = document.querySelector(".summary--billing");
var shippingSummary = document.querySelector(".summary--shipping");
var billingForm = document.querySelector(".checkout__form--billing");
var shippingForm = document.querySelector(".checkout__form--shipping");
var checkoutBtnText = document.querySelector(".btn-complete-payment span");
var checkoutSpinner = document.querySelector(".btn-complete-payment .spinner");
var checkoutPage = document.querySelector(".checkout");
var checkoutBackBtn = document.querySelector(".checkout__btn-back");
...
}(document.querySelector(".summary--billing .name"), document.querySelector(".summary--billing .email"), document.querySelector(".summary--billing .street"), document.querySelector(".summary--billing .city"));

var shippingObj = function (street, city) {
  var _street, _city;
...
function _handleCheckout() {
  _handleCheckout = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            showCheckoutPage(); // await checkout();
...
function _checkout() {
  _checkout = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var _shippingAddressArr$, _shippingAddressArr$2, _billingAddressArr$, _billingAddressArr$2;

    var token, gatewayPaymentId, items, billingAddressArr, shippingAddressArr, orderOptions;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 3;
            return (0, _commonjs.generateCheckoutToken)(currentCart.id);

          case 3:
            token = _context2.sent;
            gatewayPaymentId = token.gateways.manual[0].id;
            items = currentCart.line_items.reduce(function (acc, item) {
              acc[item.id] = {
                quantity: item.quantity
              };
              return acc;
            }, {});
            billingAddressArr = billingObj.city.split(",");
            shippingAddressArr = shippingObj.city.split(",");
            orderOptions = {
              line_items: items,
              customer: {
              ...
              shipping: {
                ...
                county_state: (_shippingAddressArr$ = shippingAddressArr[1]) !== null && _shippingAddressArr$ !== void 0 ? _shippingAddressArr$ : "",
                postal_zip_code: (_shippingAddressArr$2 = shippingAddressArr[2]) !== null && _shippingAddressArr$2 !== void 0 ? _shippingAddressArr$2 : "",
                country: "SA"
              },
              billing: {
                name: billingObj.fullname,
                ...
                county_state: (_billingAddressArr$ = billingAddressArr[1]) !== null && _billingAddressArr$ !== void 0 ? _billingAddressArr$ : "",
                postal_zip_code: (_billingAddressArr$2 = billingAddressArr[2]) !== null && _billingAddressArr$2 !== void 0 ? _billingAddressArr$2 : "",
                country: "SA"
              },
              payment: {
                gateway: "manual",
            ...
            console.log(orderOptions); // let order = await captureOder(checkout.id, orderOptions);
            // console.log(order);
